                    ...
                    <div class="mt-4 ml-4 mr-4">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-3">
                                    <input name="preparationTime" class="p-1" type="number" value="${recipe.preparationTime}">
                                </td>
                            </tr>
                            <input type="hidden" name="id" value="${recipe.id}" id="recipeId">
                            </tbody>
                        </table>
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-5 p-4">
                                <textarea name="ingredients" class="w-100 p-1" rows="10">${recipe.ingredients}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
