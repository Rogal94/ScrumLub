...
<section class="mr-4 ml-4">
    <div class="col d-flex justify-content-center mb-2">
        <a href="/recipes" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Pokaż wszystko</a>
    </div>
    <form method="POST">
        <div class="row border-bottom border-3">
            <div class="col d-flex justify-content-center mb-2">
                <input type="text" class="w-50 p-1" name="recipeName" value="Wpisz nazwę recepty">
                <button type="submit" class="btn btn-color rounded-0 pt-0 pb-0 pr-4 pl-4">Wyszukaj</button>
            </div>
        </div>
    </form>
    <table class="table">
        ...
        <tr class="d-flex">
            ...
            <td class="col-1"><a href="/app/recipe/details?recipeId=${recipe.id}" class="btn btn-info rounded-0 text-light">Szczegóły</a></td>
        </tr>
        </c:forEach>
        </tbody>
    </table>
