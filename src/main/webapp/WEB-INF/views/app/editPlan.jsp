                ...
                <form method="POST">
                    ...
                    <div class="schedules-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" value="${plan.name}" name="name" id="planName">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" name="description" id="planDescription">${plan.description}</textarea>
                            </div>
                        </div>

                    </div>
                    <input type="hidden" name="id" value="${plan.id}" id="planId">
                </form>
            </div>
        </div>
    </div>
